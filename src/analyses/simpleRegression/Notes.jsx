  ...
  return (
    <div>
      ...
      <Section title={n.formulasTitle}>
        <Formula>{n.formulaB1}</Formula>
        <Formula>{n.formulaB0}</Formula>
        <Formula>{n.formulaR2}</Formula>
        <Formula>{n.formulaAdjR2}</Formula>
        <Formula>{n.formulaF}</Formula>
        <Formula>{n.formulaBeta}</Formula>
      </Section>
