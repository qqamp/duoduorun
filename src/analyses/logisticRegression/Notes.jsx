  ...
  return (
    <div>
      ...
      <Section title={n.formulasTitle}>
        <Formula>{n.formulaLogit}</Formula>
        <Formula>{n.formulaSigmoid}</Formula>
        <Formula>{n.formulaOR}</Formula>
        <Formula>{n.formulaWald}</Formula>
        <Formula>{n.formulaLR}</Formula>
        <Formula>{n.formulaNagelkerke}</Formula>
      </Section>
