/**
 * 混合設計 ANOVA — Notes（教學模式右欄）
 * Mixed ANOVA — Notes panel (teaching mode, right column).
 */
  ...
  return (
    <div>
      ...
      <Section title={n.formulasTitle}>
        <Formula>{n.formulaSStotal}</Formula>
        <Formula>{n.formulaSSA}</Formula>
        <Formula>{n.formulaSSsubj}</Formula>
        <Formula>{n.formulaSSB}</Formula>
        <Formula>{n.formulaSSAB}</Formula>
        <Formula>{n.formulaSSerror}</Formula>
        <Formula>{n.formulaFA}</Formula>
        <Formula>{n.formulaFB}</Formula>
        <Formula>{n.formulaFAB}</Formula>
        <Formula>{n.formulaPartialEta2}</Formula>
        <Formula>{n.formulaMauchly}</Formula>
        <Formula>{n.formulaGG}</Formula>
        <Formula>{n.formulaHF}</Formula>
        <Formula>{n.formulaLB}</Formula>
      </Section>
