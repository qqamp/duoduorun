 ...
 * MANOVA — Notes（教學模式右欄）
 *
 * Right-rail teaching notes: purpose / assumptions / formulas / how-to-read.
 */
  ...
  return (
    <div>
      ...
      <Section title={n.formulasTitle}>
        <Formula>{n.formulaH}</Formula>
        <Formula>{n.formulaE}</Formula>
        <Formula>{n.formulaWilks}</Formula>
        <Formula>{n.formulaPillai}</Formula>
        <Formula>{n.formulaHL}</Formula>
        <Formula>{n.formulaRoy}</Formula>
        <Formula>{n.formulaBoxM}</Formula>
      </Section>
