/**
 * CFA — Notes（教學模式右欄）
 * Purpose / assumptions / model + fit-function formulas / how to read fit indices.
 */
  ...
  return (
    <div>
      ...
      <Section title={n.formulasTitle}>
        ...
        <Formula>{n.formulaFitFn}</Formula>
        <Formula>{n.formulaChi2}</Formula>
        <Formula>{n.formulaCfi}</Formula>
        <Formula>{n.formulaTli}</Formula>
        <Formula>{n.formulaRmsea}</Formula>
        <Formula>{n.formulaSrmr}</Formula>
        <Formula>{n.formulaDf}</Formula>
      </Section>
      <Section title={n.thresholdsTitle}>{n.thresholds}</Section>
