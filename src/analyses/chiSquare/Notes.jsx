...
function Notes() {
  ...
  const type = state?.type || 'independence'
  const n = t.chiSq.notes

  return (
    <div>
      <Section title={n.purposeTitle}>
        {type === 'independence' ? n.purposeIndep : n.purposeGof}
      </Section>
      ...
      <Section title={n.formulasTitle}>
        ...
        {type === 'independence' ? (
          <>
            <Formula>{n.formulaIndepE}</Formula>
            <Formula>{n.formulaCramer}</Formula>
          </>
        ) : (
          <Formula>{n.formulaGofE}</Formula>
        )}
        <Formula>{n.formulaResid}</Formula>
      </Section>
